...
class AcController extends AbstractController {
    ...
    public function acclusterListAction(){
        $where = array();
        $where['is_delete'] = 0;
        $where['ac_cluster_id'] = (int)$this->params()->fromPost("id", 0);
        $list = $this->_tableObj->getList($where);
